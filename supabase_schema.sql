...
CREATE TABLE IF NOT EXISTS devices (
    ...
    "customImage" TEXT DEFAULT '',
    "customImageName" TEXT DEFAULT '',
    ...
    "targetTemp" NUMERIC DEFAULT 24.0,
...
-- 10. Disable Row Level Security (RLS) to allow full API read/write access
